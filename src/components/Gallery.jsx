    ...
    <section id="gallery" className="odd py-32 overflow-hidden" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-4" ref={revealRef}>
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center mb-12 md:mb-24 min-h-[480px] md:min-h-[520px]">
          ...
          {/* Left Photo (Top Photo on Mobile) */}
          <div 
            ref={leftPhotoRef}
            className="w-full h-[240px] md:absolute md:left-[5%] lg:left-[10%] md:w-[280px] md:h-[420px] z-20 cursor-pointer md:shadow-[8px_8px_0_#C9A84C] border-[3px] border-gold rounded-[4px] mb-4 md:mb-0 transition-all duration-300 md:hover:scale-[1.03] block"
          ...
          {/* Center Card */}
          <div 
             className="relative w-[calc(100%-32px)] md:w-full max-w-[400px] md:max-w-[380px] min-h-[480px] md:min-h-[520px] bg-cream border-2 border-gold rounded-[4px] px-[20px] py-[28px] md:px-8 md:py-10 shadow-[0_20px_60px_rgba(0,0,0,0.4)] z-30 flex flex-col items-center justify-center mx-auto"
          ...
          >
            ...
            {/* Background Parallax Image - Clean, plain absolute overlay */}
            <img 
              src={images[2].url} 
            ...
            <div className="relative z-10 flex flex-col items-center text-center w-full h-full pointer-events-none">
              <span className="tamil-text text-gold mb-6 block drop-shadow-sm font-bold" style={{ fontSize: "clamp(11px, 2vw, 14px)" }}>|| சுபமங்கள விழா ||</span>
              ...
              <div className="my-6">
                ...
                <h3 className="font-heading text-dark font-bold leading-none tracking-tight block md:hidden" style={{ fontSize: "24px" }}>
                  Roshna &<br/> Selva Kumar
                </h3>
                <h3 className="font-heading text-dark font-bold leading-none tracking-tight hidden md:block" style={{ fontSize: "32px" }}>
              ...
              <div className="space-y-2 uppercase text-dark/80 font-bold mb-6 flex flex-col items-center">
                <div className="text-gold bg-gold/10 inline-block rounded border border-gold/20" style={{ fontSize: "clamp(10px, 1.5vw, 10px)", padding: "4px 10px", marginBottom: "8px" }}>Wedding Celebration</div>
                <div className="font-heading text-primary tracking-normal font-bold" style={{ fontSize: "clamp(14px, 2vw, 18px)" }}>May 18, 2026</div>
                <div className="tamil-text text-gold/80 tracking-normal normal-case mb-1" style={{ fontSize: "clamp(12px, 1.5vw, 11px)" }}>வைகாசி 4, 2026</div>
                <div style={{ fontSize: "clamp(12px, 2vw, 12px)", letterSpacing: "0.05em" }}>Alagar Kovil Temple</div>
                <div className="tamil-text text-dark/60 tracking-normal normal-case" style={{ fontSize: "clamp(11px, 2vw, 10px)" }}>அழகர் கோவில், மதுரை</div>
              </div>

              <div className="opacity-60 mb-4 drop-shadow-sm">{cornerLotus}</div>

              <div className="font-body italic text-gold/80 normal-case mb-2" style={{ fontSize: "clamp(11px, 2vw, 13px)" }}>
          ...
          {/* Right Photo (Bottom Photo on Mobile) */}
          <div 
            ref={rightPhotoRef}
            className="w-full h-[240px] md:absolute md:right-[5%] lg:right-[10%] md:w-[280px] md:h-[420px] z-20 cursor-pointer md:shadow-[8px_8px_0_#C9A84C] border-[3px] border-gold rounded-[4px] mt-4 md:mt-0 transition-all duration-300 md:hover:scale-[1.03] block"
